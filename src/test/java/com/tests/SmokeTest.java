...
public class SmokeTest {
  ...
  @Test
   public void addBranch(Method method) throws InterruptedException {
        startTest("TESTCASE 1- Verify that all the fields can be filled and save. ", "All the fields can be filled and saved.");
    ...
    public void addBranchwithmandatoryfields(Method method) throws InterruptedException {
        startTest("TESTCASE 2 - Verify that all mandatory fields are filled or not.", "All the mandatory fields can be filled.");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    public void verifyMandatorylabels(Method method) throws InterruptedException {
        startTest("TESTCASE 3 - Verify that the Mandatory field label of hierarchy field is displayed or not.", "There is no error message showing in Hierarchy field.");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    public void calenderinput(Method method) throws InterruptedException {
        startTest("TESTCASE 4 - Verify that the inaugration date can be filled by keyboard", "Inauguration date cannot be added by keyboard.");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    public void verifyphonenumber(Method method) throws InterruptedException {
        startTest("TESTCASE 5 - Verify that the signs +,- are allowed in phone number field.", "verifyphonenumber");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    public void verifybranchcode(Method method) throws InterruptedException {
        startTest("TESTCASE 6 - Verify that the Branch Code accepts only Alphanumeric value.", "Branch code ");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    public void verifybranchname(Method method) throws InterruptedException {
        startTest("TESTCASE 7 - Verify that the Branch Name accepts only Alphanumeric value.", "Branch Name");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    {
        startTest("TESTCASE 8 - Verify that the GST Field is accepting 15 valid GST Number", "GST NUMBER");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    {
        startTest("TESTCASE 9 - Verify that the service number accepts only numbers", "Service number");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    {
        startTest("TESTCASE 10 - Verify that latitude field accepts decimal value or not", "latitude");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    public void verifyLongitude(Method method) throws InterruptedException {
        startTest("TESTCASE 11- Verify that the longitude field accepts decimal value or not", "Longitude");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    {
        startTest("TESTCASE 12 - Verify that the Static IP accepts valid Ip address or not", "verifystaticip");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
    ...
    public void verifyLatitudelabel(Method method) throws InterruptedException {
        startTest("TESTCASE 13 - Verify that the Lattitude label is written correctly", "verifyLatitudelabel");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
...
//    }
    ...
    public void edit(Method method) throws InterruptedException {
        startTest("TESTCASE 15 - Verify that the edit option is working properly or not", "edit");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonbranchlist(driver);
    ...
    public void time(Method method) throws InterruptedException {
        startTest("TESTCASE 17 - Verify that the inauguration time shows only one dialog box.", "time");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonbranchlist(driver);
    ...
    public void save_already_deleted_data(Method method) throws InterruptedException {
        startTest("TESTCASE 18 - Verify that the trying to save already deleted branch details. ", "save_already_deleted_data");
        HomePage.clickOnMaster(driver);
        MasterPage.clickonAddbranch(driver);
